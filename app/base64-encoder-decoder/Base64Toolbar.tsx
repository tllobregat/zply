    ...
    <div className={cn("flex items-center gap-3", isDropdown && "flex-col items-stretch")}>
      <div className={cn(
        ...
        >
          ...
          <span className={cn('md:inline', !isDropdown && 'hidden')}>Encode</span>
        </Button>
        <Button
        ...
        >
          ...
          <span className={cn('md:inline', !isDropdown && 'hidden')}>Decode</span>
        </Button>
      </div>
        ...
        && (
          <div className={cn(
            ...
            >
              ...
              <span className={cn('md:inline', !isDropdown && 'hidden')}>Text</span>
            </Button>
            <Button
            ...
            >
              ...
              <span className={cn('md:inline', !isDropdown && 'hidden')}>File</span>
            </Button>
          </div>
        )
      }
