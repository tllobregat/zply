...
import { PlantUmlError } from './plantuml.types';

interface PlantUmlErrorOverlayProps {
  error: PlantUmlError | null;
}

export function PlantUmlErrorOverlay({ error }: PlantUmlErrorOverlayProps): React.ReactNode {
