        ...
        <header className="px-4 sm:px-8 py-4 flex items-center justify-between shrink-0">
          <div className="flex flex-col min-w-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl sm:text-2xl font-black tracking-tight truncate">{t('title')}</h1>
            </div>
          </div>
        </header>
      }
      footer={<DashboardFooter />}
      contentClassName="p-4 sm:p-8 bg-island-bg/5"
    >
      <motion.div
      ...
      >
        ...
        <section className="p-8 bg-blue-500/5 border border-blue-500/20 rounded-2xl space-y-6">
          <div className="flex items-center gap-3">
