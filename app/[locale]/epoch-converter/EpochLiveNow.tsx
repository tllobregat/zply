  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="px-4 py-2 rounded-xl bg-island-bg border border-island-border flex items-center gap-3 w-full md:w-auto">
        ...
        <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">{tCommon('toolIndicators.liveNow')}:</span>
      ...
      >
        <RefreshCw className="w-3.5 h-3.5" /> {tCommon('toolActions.useCurrentTime')}
      </Button>
    </div>
  );
}
