...
import { Base64Mode, InputType, TransformationResult } from '@/app/[locale]/base64-encoder-decoder/base64.types';
import { Base64FileUpload } from '@/app/[locale]/base64-encoder-decoder/Base64FileUpload';
import { Base64Preview } from '@/app/[locale]/base64-encoder-decoder/Base64Preview';
import { Base64PreviewHeader } from '@/app/[locale]/base64-encoder-decoder/Base64PreviewHeader';
import { Base64Toolbar } from '@/app/[locale]/base64-encoder-decoder/Base64Toolbar';
...
export default function Base64Client(): ReactNode {
  ...
  return (
    <ToolPageLayout
      ...
      title={t(`${ToolId.BASE64}.title`)}
      icon={<Binary className="w-5 h-5" />}
      breadcrumbItems={[
        { label: tCategories(Category.ENCODING), href: `/?category=${Category.ENCODING}` },
        { label: t(`${ToolId.BASE64}.title`) }
      ]}
      headerActions={
        <Base64Toolbar
          mode={state.mode}
