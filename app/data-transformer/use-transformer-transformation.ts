import { JsonValue } from '@/app/json-utils/types';
import { parseTypeScriptToMock, jsonToTypeScript } from '@/app/data-transformer/transformer.utils';
import { Logger } from '@/lib/logger';
import { XMLBuilder, XMLParser } from 'fast-xml-parser';
import yaml from 'js-yaml';
import { useMemo } from 'react';
import Papa, { ParseResult } from 'papaparse';
import { TransformerState, DataFormat } from '@/app/data-transformer/transformer.types';
